...
async function upsertUser(
  ...
  // Check if user exists with this email (from signup)
  ...
  const userData = {
    ...
    role: existingUserByEmail?.role || "client",
    company: existingUserByEmail?.company,
  };

  // If user signed up before, delete the temporary record and use the OAuth ID
  if (existingUserByEmail && existingUserByEmail.id.startsWith('temp-')) {
