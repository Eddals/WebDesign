...
const TestHubSpot: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const webhookUrl = 'https://api-na2.hubapi.com/automation/v4/webhook-triggers/243199316/aphYKvD';
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      ...
      <div className="mb-6 p-4 bg-green-100 border border-green-300 rounded-md">
        <p className="text-green-800">Este formulário envia dados para o webhook do HubSpot <code>243199316/aphYKvD</code> através da nossa API</p>
      </div>
