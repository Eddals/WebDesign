...
export default async function handler(req, res) {
  ...
  try {
    ...
    const apiKey = process.env.BREVO_API_KEY || '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';

    // 1. Email para a equipe
    const emailData = {
    ...
    if (!response.ok) {
      ...
      return res.status(500).json({ error: 'Failed to send estimate email', details: emailResult });
    }
