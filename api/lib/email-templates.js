...
// Newsletter subscriber template - simple thank you message
...
<body style="margin: 0; padding: 0; font-family: Arial, sans-serif; background-color: #f5f5f5; line-height: 1.6;">
  <div style="max-width: 600px; margin: 20px auto; background-color: #ffffff; border: 1px solid #ddd; border-radius: 5px;">
    ...
    <div style="background-color: #7c3aed; color: #ffffff; padding: 20px; text-align: center; border-radius: 5px 5px 0 0;">
      <h1 style="margin: 0; font-size: 22px;">Thanks for Subscribing!</h1>
    </div>
    
    <div style="padding: 30px;">
      <p style="margin-bottom: 20px; color: #333;">Hi ${subscriberData.name},</p>
      
      <p style="margin-bottom: 20px; color: #333;">Thank you for subscribing to our newsletter. We'll keep you updated with our latest news and offerings.</p>
      
      <p style="margin-bottom: 20px; color: #333;">Best regards,<br>The DevTone Team</p>
    </div>
    
    <div style="background-color: #f5f5f5; padding: 15px; text-align: center; font-size: 12px; color: #666; border-radius: 0 0 5px 5px;">
      <p style="margin: 0;">© ${new Date().getFullYear()} DevTone Agency. All rights reserved.</p>
    </div>
  </div>
</body>
</html>
...
// Newsletter admin notification template - simple notification
...
<body style="margin: 0; padding: 0; font-family: Arial, sans-serif; background-color: #f5f5f5; line-height: 1.6;">
  <div style="max-width: 600px; margin: 20px auto; background-color: #ffffff; border: 1px solid #ddd; border-radius: 5px;">
    ...
    <div style="padding: 30px;">
      <p style="margin-bottom: 20px; color: #333;">A new user has subscribed to the newsletter:</p>
      
      <table style="width: 100%; border-collapse: collapse; margin-bottom: 20px;">
        <tr>
          <td style="padding: 6px 0; color: #666; font-weight: bold; width: 100px;">Name:</td>
          <td style="padding: 6px 0; color: #333;">${subscriberData.name}</td>
        </tr>
        <tr>
          <td style="padding: 6px 0; color: #666; font-weight: bold;">Email:</td>
          <td style="padding: 6px 0; color: #333;">${subscriberData.email}</td>
        </tr>
        <tr>
          <td style="padding: 6px 0; color: #666; font-weight: bold;">Source:</td>
          <td style="padding: 6px 0; color: #333;">${subscriberData.source}</td>
        </tr>
        <tr>
          <td style="padding: 6px 0; color: #666; font-weight: bold;">Date:</td>
          <td style="padding: 6px 0; color: #333;">${subscriberData.subscribedAt}</td>
        </tr>
      </table>
    </div>
